...
function exercise4(varA, varB) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
  if ((typeof varA === "string" && typeof varB === "string" && varA === varB) || (typeof varA === "number" && typeof varB === "number" && varA === varB)){
...
function exercise6(varA, varB, varC) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
  if ((typeof varA === "string" && typeof varB === "string" && varA === varB || varC !== varB || varC !== varA)  ||
  (typeof varA === "number" && typeof varB === "number" && varA === varB || varC !== varB || varC !== varA) ||
  typeof varA === "object" && typeof varB === "object" && JSON.stringify(varA) === JSON.stringify(varB) || JSON.stringify(varA) !== JSON.stringify(varC) || JSON.stringify(varB) !== JSON.stringify(varC)){
    answer6 = true;
  }else {
    answer6 = false;
  }
